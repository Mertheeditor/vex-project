...
import { RemindersView, type ReminderData } from "./views/RemindersView";
import { TasksView, type ActiveTaskResponse, type TaskData, type TaskFromChatResult } from "./views/TasksView";
import "./App.css";
    ...
    <main className="app-shell">
      <aside className="sidebar">
        ...
        <nav className="nav-list">
          ...
          <button
            className={`nav-item ${activeView === "site-audit" ? "active" : ""}`}
            onClick={() => setActiveView("site-audit")}
          >
            Site Audit
          </button>
          <button
      ...
      <section className="chat-area">
        ...
        {activeView === "dashboard" ? (
          <DashboardView
            ...
            isActiveProjectDetailLoading={isActiveProjectDetailLoading}
        ...
        {activeView === "tasks" ? <TasksView tasks={tasks} activeTaskId={activeTaskId} isTasksLoading={isTasksLoading} onRefresh={loadTasks} onSelectTask={setTaskAsActive} onCompleteTask={completeTask} onDeleteTask={deleteTask} /> : null}
